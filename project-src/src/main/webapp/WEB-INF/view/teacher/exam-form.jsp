...
<div class="container">
    ...
    <div id="container">
        ...
        <form:form action="${pageContext.request.contextPath}/teacher/exam/save" modelAttribute="exam" method="POST">
            <form:hidden path="id"/>
            <table>
                <colgroup>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form:errors path="subject.id" cssClass="error"/>
                    </td>
                </tr>
                <tr>
                    <td><label></label></td>
                    <td>
                        ...
                        <button onclick="if((confirm('คุณแน่ใจหรือว่าต้องการลบข้อมูลนี้ ?'))) { window.location.href='${pageContext.request.contextPath}/teacher/exam/${exam.id}/delete'; return false; }"
                                class="cancel-button">
