...
<div class="container">
    ...
    <div id="container">
        ...
        <form:form action="${pageContext.request.contextPath}/teacher/exam/${exam.id}/section/${section_id}/update/question" modelAttribute="multiChoiceQuestion" method="POST">
            <form:hidden path="id"/>
            <table>
                <colgroup>
